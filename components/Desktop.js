...
export default function DesktopComponent() {
  return (
    <div>
      ...
      <Grid container>
        <Grid item className="wrap_left" align="left" xs={12} md={6}>
        ...
        <Grid item className="wrap_right" align="right" xs={12} md={6}>
          <Paper
            color="neutral"
            alt="Avatars 1"
            align="center"
        ...
        <Grid item align="center" xs={12} md={4} marginBottom={10}>
        ...
        <Grid item className="wrap_right" align="center" xs={12} md={4}>
